...
const Cities = (props) => {
  ...
  let districtName = props.district
  ...
  if (cities) {
    currentItems = cities.slice(indexOfFirstItem, indexOfLastItem);
    totalPages = Math.ceil(cities.length / itemsPerPage); // Should always be 10 given 300 items
  }
  return (
    <div>
      {/* Card component */}
      <div className=" flex items-center justify-center py-8 px-4">
        <div className="lg:w-1/2 md:w-10/12 w-full flex flex-col items-center ">
          ...
          {currentItems.map((city, index) => (
            ...
            >
              <Link href={`/bank/${bankName}/district/${districtName}/city/${city}`}>
